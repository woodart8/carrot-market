  ...
  return (
      <div className="bg-slate-400 xl:place-content-center px-20 py-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
        <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
          ...
          <button className="flex justify-center mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto
          hover:bg-teal-500 dark:hover:bg-white dark:hover:text-black active:bg-yellow-500">
            Checkout
          </button>
        </div>
        <div className="bg-white overflow-hidden rounded-3xl shadow-xl">
          <div className="portrait:bg-blue-500 landscape:bg-teal-500 p-6 pb-14 xl:pb-48">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-xl lg:col-span-2 xl:col-span-1">
          <div className="flex mb-5 justify-between items-center">
            ...
            <div className="space-x-3">
              ...
              <span className="font-semibold relative -left-2">4.9</span>
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-3 mb-5 flex justify-between">
              ...
              <div className="flex items-center space-x-4">
                <button className="p-1.5 bg-blue-200 flex justify-center items-center aspect-square w-8 font-semibold rounded-lg text-gray-500">-</button>
                <span>1</span>
                <button className="p-1.5 bg-blue-200 flex justify-center items-center aspect-square w-8 font-semibold rounded-lg text-gray-500">+</button>
              </div>
            </div>
            <div className="flex justify-between items-center">
              ...
              <button className="bg-blue-500 p-2 text-center text-white rounded-lg py-2 px-8">Add to cart</button>
            </div>
          </div>
        </div>
      </div>
